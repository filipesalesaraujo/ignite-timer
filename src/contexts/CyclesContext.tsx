...
import { ActionTypes, Cycle, cyclesReduce } from '../reducers/cycles'
...
interface CyclesContextPrviderProps {
  children: ReactNode
}

export function CyclesContextProvider({ children }: CyclesContextPrviderProps) {
